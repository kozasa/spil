...
class LineBotMassage
{
     ...
     * @return array
     */
    public function push_join_message_seven($info){
     ...
     * @return array
     */
    public function push_join_message_one($info){
     ...
     * @return array
     */
    public function push_event_info($info,$event_id){
     ...
     * @return array
     */
    public function push_new_info($info,$date){
